import 'package:EventHopper/screens/home/components/search_fields.dart';
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder(
                      future: Provider.of<SessionManager>(context).currentUser,
                      builder: (context, user) => user.hasData
                          ? Text(
                              "Hey ${user.data.fullName.toString().split(' ')[1]}",
                              style: TextStyle(
